...
class ShiroDbRealm {
    ...
    def authenticate(authToken) {
        ...
        // in the database.
        def account = new SimpleAccount(username, user.passwordHash, "com.mr.auth.ShiroDbRealm")
    ...
    def isPermitted(principal, requiredPermission) {
        ...
        def results = ShiroUser.executeQuery("select distinct p from com.mr.auth.ShiroUser as user join user.roles as role join role.permissions as p where user.username = '$principal'")
