...
<div id="footer">
    <div id="footerContent" style="margin-top: 80%;margin-bottom: 5%;  margin-left: 15%;margin-right: 15%">
        © 2012 Money Hound, Inc. All rights reserved.  Money Hound is registered trademarks of  Money Hound, Inc.
