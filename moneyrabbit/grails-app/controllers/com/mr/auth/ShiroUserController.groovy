...
class ShiroUserController {
    ...
    def save = {
        ...
        flash.message = message(code: 'default.created.message', args: [message(code: 'shiroUser.label', default: 'com.mr.auth.ShiroUser'), shiroUserInstance.id])
    ...
    def show = {
        ...
        if (!shiroUserInstance) {
            flash.message = message(code: 'default.not.found.message', args: [message(code: 'shiroUser.label', default: 'com.mr.auth.ShiroUser'), params.id])
    ...
    def update = {
        ...
        if (params.version) {
            ...
            if (shiroUserInstance.version > version) {
                shiroUserInstance.errors.rejectValue("version", "default.optimistic.locking.failure",
                        [message(code: 'shiroUser.label', default: 'com.mr.auth.ShiroUser')] as Object[],
                        "Another user has updated this com.mr.auth.ShiroUser while you were editing")
        ...
        flash.message = message(code: 'default.updated.message', args: [message(code: 'shiroUser.label', default: 'com.mr.auth.ShiroUser'), shiroUserInstance.id])
        redirect(action: "show", id: shiroUserInstance.id)
    }
    ...
    def delete = {
        ...
        try {
            ...
            flash.message = message(code: 'default.deleted.message', args: [message(code: 'shiroUser.label', default: 'com.mr.auth.ShiroUser'), params.id])
            redirect(action: "list")
        }
        catch (DataIntegrityViolationException e) {
            flash.message = message(code: 'default.not.deleted.message', args: [message(code: 'shiroUser.label', default: 'com.mr.auth.ShiroUser'), params.id])
